...
/**
 * La classe Cliente estende la classe Persona rappresentando un cliente astratto di una biblioteca.
...
public class Cliente extends Persona {
    ...
    public Cliente(String NomeC,String CognomeC,String CodicefC)
        {
            this.nome = NomeC;  // Se l'attributo fosse 'private', avremmo errore.
